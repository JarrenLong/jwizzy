...
static char g_szClassName[] = "JincS WYSIWYG Editor v1.2";
   ...
   switch(Message)
   {
      ...
      case WM_COMMAND:
         switch(LOWORD(wParam))
         {
            ...
            case CM_EDIT_TIMEDATE:
                MessageBox (NULL, "Function not yet implemented." , "JincS WYSIWYG Editor v1.2", MB_ICONEXCLAMATION);
            break;
            case CM_ABOUT:
               MessageBox (NULL, "Copyright(c)2004 JincS. All Rights Reserved.\n\nWritten by Jarren Long." , "JincS WYSIWYG Editor v1.2", MB_ICONEXCLAMATION);
         }
      break;
      case WM_CLOSE:
         DestroyWindow(hwnd);
